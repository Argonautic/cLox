clox: src/main.o src/chunk/chunk.o src/memory/memory.o  # Dependency files (e.g. main.o, chunk.o) will be created at the path specified here (why?)
	clang -o clox src/main.o src/chunk/chunk.o src/memory/memory.o
